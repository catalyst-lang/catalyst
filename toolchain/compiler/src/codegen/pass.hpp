...
struct pass {
    ...
    virtual int process(ast::decl_iface &decl) { return 0; };
    virtual int process(ast::decl_ns &decl) { return 0; };
    ...
    virtual int process_after(ast::decl_iface &decl) { return 0; };
    virtual int process_after(ast::decl_ns &decl) { return 0; };
    ...
    int walk(ast::decl_iface &decl);
    int walk(ast::decl_ns &decl);
